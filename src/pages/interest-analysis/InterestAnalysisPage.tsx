...
//                 const isTracking = campaign.is_tracking;
//                 const canSelect =
//                   !isTracking && (isSelected || selectedCampaignIds.length < 3);
...
//                     className={`relative bg-white dark:bg-gray-800 rounded-xl border-2 p-4 transition-all cursor-pointer ${
//                       isTracking
