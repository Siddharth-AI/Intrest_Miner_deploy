...
const WhatsAppSessions = () => {
  ...
  const { whatsappSessions, selectedSession, sessionMessages, loading, error } =
    ...
    <div className="container mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button
          ...
          <RefreshCw
            className={`w-4 h-4 ${loading.sessions ? "animate-spin" : ""}`}
          />
        </Button>
      </div>
          ...
          {loading.sessionDetails ? (
            ...
            selectedSession && (
              <div>
                <div className="mb-4 p-4 bg-gray-100 rounded">
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div>
                      ...
                      <Badge
                        className={getSourceBadgeColor(selectedSession.source)}>
                    ...
                    <div>
                      ...
                      <Badge
                        className={getStatusBadgeColor(selectedSession.status)}>
                ...
                {/* 🔥 REMOVED: Qualify Lead button - Lead is auto-created, use Conversion Dashboard for actions */}
                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded text-sm text-blue-800">
                  💡 <strong>Tip:</strong> Lead is automatically created when
                  message is received. Go to{" "}
                  <strong>Conversion Dashboard</strong> to send to Meta,
                  qualify, or convert this lead.
                </div>
              </div>
            )
          )}
